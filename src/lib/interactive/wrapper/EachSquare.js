...
import SquareSimple from "../components/SquareSimple";
import ClickableCircle from "../components/ClickableCircle";
import HoverTextNearMouse from "../components/HoverTextNearMouse";

class EachSquare extends Component {
	constructor(props) {
		super(props);
